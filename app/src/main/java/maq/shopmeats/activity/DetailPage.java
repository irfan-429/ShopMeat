...
import maq.shopmeats.BuildConfig;
import maq.shopmeats.Getset.CustomMarker;
import maq.shopmeats.Getset.cartgetset;
import maq.shopmeats.Getset.detailgetset;
import maq.shopmeats.Getset.favgetset;
import maq.shopmeats.R;
import maq.shopmeats.utils.GPSTracker;
import maq.shopmeats.utils.sqliteHelper;
...
import static maq.shopmeats.activity.MainActivity.tf_opensense_medium;
...
public class DetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void initializations() {
        ...
        gpsTracker = new GPSTracker(DetailPage.this);
    }
    ...
    private void getData() {
        ...
        shareDialog.registerCallback(callbackManager, new FacebookCallback<Sharer.Result>() {
            ...
            public void onSuccess(Sharer.Result result) {
                Toast.makeText(DetailPage.this,getString(R.string.shared_post), Toast.LENGTH_SHORT).show();
            }
    ...
    class GetDataAsyncTask extends AsyncTask<Void, Void, Void> {
            ...
            try {
                ...
                switch (Obj1.getString("status")) {
                    case "Success":
                        ...
                        temp.setDelivery_charge(jsonO.getString("delivery_charge"));
                    ...
                    case "Failed":
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(DetailPage.this, getString(R.string.servererror), Toast.LENGTH_SHORT).show();
                            }
                        });
                        break;
                    default:
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(DetailPage.this, getString(R.string.try_again), Toast.LENGTH_SHORT).show();
                            }
                        });
                        break;
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (detaillist.size() > 0) {
                ...
                double result=checkDistance(Double.parseDouble(detaillist.get(0).getLat()), Double.parseDouble(detaillist.get(0).getLon()), gpsTracker.getLatitude(), gpsTracker.getLongitude());
                txt_distance.setText(String.format("%.1f", result) + " " + getResources().getString(R.string.km));
                ...
                txt_deliverydesc.setText((detaillist.get(0).getDelivery_time()+" min"));
...
//                }
            ...
            btn_menu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    iv.putExtra("delivery_charge", "" + detaillist.get(0).getDelivery_charge());
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    try {
                                        ...
                                        Toast.makeText(DetailPage.this, getString(R.string.whatsapp_notinstalled), Toast.LENGTH_LONG)
                                                .show();
                                    }
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, getString(R.string.facebook),
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    String Name = detaillist.get(0).getName() + "\n";
                                    String address = getString(R.string.address1) + detaillist.get(0).getAddress() + "\n";
                                    String Mobile = getString(R.string.mobile_no1) + detaillist.get(0).getPhone() + "\n";
