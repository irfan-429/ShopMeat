...
import maq.shopmeats.Getset.registergetset;
...
public class Login extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void initializations() {
        ...
        forgot_pwd = findViewById(R.id.tv_forgot_pwd);
            ...
            try {
                ...
                if (Obj.getString("status").equals("Success")) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(Login.this, getString(R.string.servererror), Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    });
            ...
            if (isSuccess) {
                ...
                switch (key) {
                    ...
                    case "PlaceOrder": {
                        ...
                        iv.putExtra("delcharge", getIntent().getStringExtra("delcharge"));
                        iv.putExtra("couponcode", getIntent().getStringExtra("couponcode"));
                        iv.putExtra("coupondisc",getIntent().getStringExtra("coupondisc"));
                        iv.putExtra("price",  getIntent().getStringExtra("price"));
                        iv.addFlags(Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY);
                        startActivity(iv);
                        finish();
                        break;
