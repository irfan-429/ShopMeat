...
public class DeliveryOrderDetail extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        if (orderStatus.equals(getString(R.string.order_processing))) {
            img_user.setImageDrawable(getDrawable(R.drawable.img_orderprocess));
        } else if (orderStatus.equals(getString(R.string.order_ready_to_delivery))) {
            img_user.setImageDrawable(getDrawable(R.drawable.img_orderprocess));

        } else if (orderStatus.equals(getString(R.string.order_delivered))) {
            ...
            try {
                ...
                if (jsonObject.getString("success").equals("1")) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(DeliveryOrderDetail.this, getString(R.string.servererror), Toast.LENGTH_SHORT).show();
                        }
                    });
