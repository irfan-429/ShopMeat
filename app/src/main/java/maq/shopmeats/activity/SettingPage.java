...
import maq.shopmeats.Adapter.CityListAdapter;
...
public class SettingPage extends AppCompatActivity {
    ...
    private void getSharedPref() {
        String MY_PREFS_NAME = "Shopmeats";
    ...
    private void initView() {
        ...
        if (radius == noRadius) {
            ...
            txt_radius.setText(defaultRadius + getString(R.string.km));
            disableRadiusLayout();

        } else {
            radius_seekBar.setProgress(radius);
            txt_radius.setText(radius + getString(R.string.km));
    ...
    private void disableRadiusLayout() {
        ...
        txt_radius.setText(radius1 + " " + getString(R.string.km));
        editor.apply();
