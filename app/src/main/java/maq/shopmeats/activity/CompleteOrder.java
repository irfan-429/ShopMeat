...
import maq.shopmeats.Getset.orderTimelineGetSet;
import maq.shopmeats.R;
import maq.shopmeats.timeline.OrderStatus;
import maq.shopmeats.timeline.TimeLineAdapter;
import maq.shopmeats.timeline.TimeLineModel;
...
public class CompleteOrder extends AppCompatActivity {
    ...
    private void initView() {
        ...
        txt_orderno.setText(getString(R.string.order_no) + orderId);
