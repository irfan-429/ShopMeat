...
import maq.shopmeats.Getset.myOrderGetSet;
import maq.shopmeats.Getset.placeordergetset;
   ...
   sqliteHelper sqliteHelper;
    ...
    private void validation() {
        if (edt_address.getText().toString().trim().isEmpty()) {
            edt_address.setError(getString(R.string.txt_select_location));
        } else if (edt_note.getText().toString().trim().isEmpty()) {
            edt_note.setError(getString(R.string.description));
        } else {
